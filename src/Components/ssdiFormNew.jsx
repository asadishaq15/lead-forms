...
const SSDIInboundFormNew = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const requiredFields = ["caller_id", "first_name", "last_name"];
    ...
    if (!/^\+1\d{10}$/.test(formData.caller_id)) {
      setError("Please enter a valid phone number in the format: +1 followed by 10 digits (e.g., +17194451111)");
      return;
    }
            ...
            <div className="grid grid-cols-1 gap-6">
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full rounded-md border-2 border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 p-2"
                />
                <p className="mt-1 text-xs text-gray-500">Format: +1 followed by 10 digits (e.g., +17194451111)</p>
              </div>
            </div>
          </div>
...
export default SSDIInboundFormNew;