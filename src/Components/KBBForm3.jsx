...
const KbbSalesGroupLeadForm = () => {
  const [formData, setFormData] = useState({
    lead_token: "e7eb9125a6974724ad6f029bacaa0706",
    caller_id: "",
    traffic_source_id: "1074",
    gender: "",
        ...
        <form onSubmit={handleSubmit} className="px-6 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div className="relative">
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Traffic Source Lead ID
                </label>
                <input
                  type="text"
                  name="traffic_source_lead_id"
                  value={formData.traffic_source_lead_id}
                  onChange={handleChange}
                  className="block w-full px-4 py-3 rounded-lg border-2 border-gray-300 focus:ring-blue-500 focus:border-blue-500 transition duration-150"
                  placeholder="Enter Traffic Source Lead ID"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-8 border border-gray-200">
            ...
            <ul className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-x-6 text-sm text-gray-600">
              <li className="flex items-center">
                ...
                Lead Token: e7eb9125a6974724ad6f029bacaa0706
              </li>
              <li className="flex items-center">
                <svg className="h-4 w-4 text-green-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                Traffic Source ID: 1074
              </li>
            </ul>
          </div>
...
export default KbbSalesGroupLeadForm;