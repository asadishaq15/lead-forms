...
const KBBSalesGroupLeadForm2 = () => {
  const [formData, setFormData] = useState({
    lead_token: "ce4db165212347729386fa87ac4e9902",
    caller_id: "",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-teal-600 py-8 px-6">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-8">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-8 border border-gray-200">
            ...
            <ul className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-x-6 text-sm text-gray-600">
              <li className="flex items-center">
                ...
                Lead Token: ce4db165212347729386fa87ac4e9902
              </li>
              <li className="flex items-center">
                <svg className="h-4 w-4 text-green-500 mr-1" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                Traffic Source ID: 1013
              </li>
            </ul>
          </div>
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full flex justify-center items-center py-4 px-6 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-gradient-to-r from-blue-600 to-teal-600 hover:from-blue-700 hover:to-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ${isSubmitting ? 'opacity-75 cursor-not-allowed' : ''}`}
            >
              {isSubmitting ? (
                <>
...
export default KBBSalesGroupLeadForm2;